export const translations = {
  en: {
    ...
    hero: {
      ...
      role: "WEB DEVELOPER",
      intro:
        "I build clean React interfaces and practical Node.js backends. My work centers on usable flows, clear UI, and maintainable backend structure.",
      cta: "VIEW MY WORK",
      scroll: "SCROLL",
      status: "OPEN TO WORK",
    },
  ...
  id: {
    ...
    hero: {
      ...
      role: "PENGEMBANG WEB",
      intro:
        "Saya programmer pengguna React dan backend Node.js. misi yang saya kejar: alur yang mudah dipakai, UI yang sesuai, dan struktur backend yang maintainable.",
